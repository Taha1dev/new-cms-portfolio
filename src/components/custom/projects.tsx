...
import PulsingBorderShader from "./chunks/pulsing-border-shader"
export const ProjectsSection = () => {
  const projects = [
    ...
    },
    {
      ...
      description: "Responsive portfolio site with advanced animations and optimized performance.",
      image: "/placeholder.svg?height=300&width=500",
  ...
  return (
    <div className="relative">
      <PulsingBorderShader />
      <section id="projects" className="py-12 sm:py-20 px-4 max-w-7xl mx-auto">
        <motion.div

  ...
  const projects = [
    {
      ...
      stack: ["Angular", "Angular Material", "TypeScript", "RxJs", "TailwindCss"],
      featured: true,
      github: "#",
      demo: "#",
    },
    {
      name: "Syrian Evisa Platoform",
    ...
    {
      name: "Syrian Exparties Platform",
    ...
    },
    {
      ...
      stack: ["React", "Nextjs", "Typescript", "axios", "shadcn/ui"],
      featured: false,
      github: "#",
      demo: "#",
    },
    {
      name: "Projtech Landing Page",
      description:
        "Modern e-commerce solution with advanced filtering, real-time inventory, and seamless checkout experience.",
      image: "https://avatar.vercel.sh/jenny",
      stack: ["React", "Nextjs", "Typescript", "react-qurey", "shadcn/ui", "i18n-next", "framer-motion", "Formik & Yup"],
      featured: true,
      github: "#",
      demo: "#",
    },
    {
      name: "Cordoba E-school",
      description: "Comprehensive analytics dashboard with real-time data visualization and interactive charts.",
      image: "https://avatar.vercel.sh/james",
      stack: ["React", "Nextjs", "Typescript", "react-qurey", "shadcn/ui", "i18n-next", "framer-motion", "Formik & Yup", "Strapi Api"],
      featured: true,
      github: "#",
      demo: "#",
    },
    {
      name: "Zaitoon E-commerce",
      description: "Comprehensive analytics dashboard with real-time data visualization and interactive charts.",
      image: "https://avatar.vercel.sh/james",
      stack: ["React", "Nextjs", "Typescript", "react-qurey", "shadcn/ui", "i18n-next", "framer-motion", "Formik & Yup", "Strapi Api"],
      featured: true,
    ...
    {
      name: "Sevilla Verlag Book Store",
      description: "Comprehensive analytics dashboard with real-time data visualization and interactive charts.",
      image: "https://avatar.vercel.sh/james",
      stack: ["React", "Nextjs", "Typescript", "react-qurey", "shadcn/ui", "i18n-next", "framer-motion", "Formik & Yup", "Strapi Api"],
      featured: true,
